...
export default function AssignmentContainer() {
  ...
  return (
    <div className="assignment p-6 bg-white shadow-lg h-screen flex flex-col relative">
      {/* Upload calendar */}
      ...
      <div className="flex-grow mb-4">
        ...
        <div className="fixed bottom-4 inset-x-4 z-50 flex justify-between items-center">
          <button 
            onClick={() => setWeekOffset(weekOffset - 1)}
            className="prev-week-details"
            style={{ marginRight: '53rem', marginLeft: '1rem'}}
          >
